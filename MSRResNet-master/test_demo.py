...
def main():
    ...
    # load model
    # --------------------------------
    model_path = os.path.join('MSRResNetx4_model', 'model_best.pt')
    model = GCSR()
    ...
    for img in util.get_image_paths(L_folder):
        ...
        #img_R= util.read_img(img)
        img_L = util.uint2tensor4(img_L)
        img_L = util.augment_img_tensor(img_L)
...
#        test_results['runtime'].append(end-start)  # seconds
        ...
        #print(a= util.calculate_psnr(img_E,img_R))
