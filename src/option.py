...
parser = argparse.ArgumentParser(description='RDNA        ')
...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/yx/dataset',
...
parser.add_argument('--model', default='AIM2020',
                    help='model name')
...
parser.add_argument('--G0', type=int, default=48,
...
parser.add_argument('--reduction', type=int, default=11,
...
parser.add_argument('--lr', type=float, default=2.56e-4,
                    help='learning rate')
parser.add_argument('--decay', type=str, default='1160-1180-1200',
                    help='learning rate decay type') #100-159
...
# Log specifications
parser.add_argument('--save', type=str, default='AIMFinal3',
