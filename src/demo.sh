...
python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_x2 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --ext img

# EDSR in the paper (x3) - from EDSR (x2)
#python main.py --model EDSR --scale 3 --save edsr_x3 --n_resblo.sh democks 32 --n_feats 256 --res_scale 0.1 --reset --pre_train [pre-trained EDSR model dir]
